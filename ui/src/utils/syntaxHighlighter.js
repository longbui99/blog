function tokenizePythonCode(code) {
  const tokenPatterns = {
    keyword: {
      pattern: /\b(class|if|from|import|while|for|in|is|as|with|try|except|finally|raise|assert|and|or|not|elif|else|pass|break|continue|lambda|yield|global|nonlocal)\b/g,
